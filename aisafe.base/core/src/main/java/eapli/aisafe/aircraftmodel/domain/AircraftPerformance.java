...
/**
 * Value Object: manufacturer-certified aircraft performance parameters.
 * Units follow standard aviation conventions:
 *   - serviceCeiling  in metres (m)
 *   - cruiseSpeed     in knots (kt) — standard aviation unit per ICAO
 *   - maximumRange    in nautical miles (NM) — manufacturer-rated max range
 * US055.
 */
@Embeddable
